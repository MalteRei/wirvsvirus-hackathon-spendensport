...
export class GoalCreationService {
  ...
  private GoalToCreate: IGoal = new Goal('mein Ziel', 5, false, 'https://www.betterplace.org/', new Date());
  ...
  public submitGoal() {
    ...
    this.GoalToCreate = new Goal('mein Ziel', 5, false, 'https://www.betterplace.org/', new Date());
